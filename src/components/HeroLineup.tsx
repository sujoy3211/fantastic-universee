...
const heroes = [
  {
    ...
    title: "The Brain",
    image: "/sujoy.jpg",
    bio: "The Strategic the Brain of the group. Thinking 10 steps ahead while everyone else is still at the start.",
  ...
  },
  {
    ...
    title: "Clever & Funny",
    image: "/arijit.jpg",
    bio: "The Chaos Master. combination of Genius & comedian, 100% unpredictable.",
